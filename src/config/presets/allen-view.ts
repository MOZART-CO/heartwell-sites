...
/**
 * Allen View Healthcare Center — Springfield, Ohio.
 *
 ...
 */
const c = BY_ID['allen-view'];

export const preset: SiteConfig = {
  slug: 'allen-view',
  kind: 'community',
  community: 'allen-view',
  ...
  url: 'https://allen-view.mzrt.work',
  domain: 'allen-view.mzrt.work',
  ...
  formsSlug: 'allen-view',                    // TODO: run the mozart-form-setup skill for this slug

  communities: ['allen-view'],
  copyrightYear: 2026,
  assetsBase: '',
};
